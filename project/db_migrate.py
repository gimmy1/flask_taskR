...
with sqlite3.connect(DATABASE_PATH) as connection:
    # get a cursor object started
    c = connection.cursor()

    # temporarily change the name of the alter table
    ...
    c.executemany("""
        INSERT INTO tasks (name, due_date, priority, status, posted_date, user_id) VALUES(?, ?, ?, ?, ?, ?)""", data)
